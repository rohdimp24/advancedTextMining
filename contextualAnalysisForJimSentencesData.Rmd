...
subcases<-dbGetQuery(mydb, "SELECT * FROM `smartsignal_jim_allfields` where equipmentType='STEAM_TURBINE' LIMIT 2000")
...
write.csv(outputMatrix,"output_jim_STEAM_TURBINE.csv")
