...
24/Oct/2016: This script merges the two approaches together that is using the new dictionary system and with POS
...
subcases<-dbGetQuery(mydb, "SELECT * FROM `originalss`")
